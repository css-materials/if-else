...
Observe the syntax and describe what each code example does. Try to predict the output. Then run the code to check your understanding.
...
Example 5 (the modulo operator `%%` returns the remainder after a division)
```{r}
x <- 15
